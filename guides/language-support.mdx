...
3. **Quality Assurance** - Optional AI Review can further polish the translated text for clarity and accuracy
...
2. **Enable AI Review** - Helps polish transcripts and correct errors
3. **Specify the language** manually if auto-detect struggles with your dialect
4. **Review transcripts** for critical applications to ensure accuracy
5. **Report issues** to help us improve support for your language
