...
3. Configure optional features (Speaker Diarization, AI Review, etc.)
...
Enhance transcript quality with AI-powered polishing.

**What it does:**
- Removes filler words ("um", "uh", "like")
- Fixes transcription errors and typos
- Adds proper capitalization and punctuation
- Recognizes technical terms and jargon
- Improves sentence structure

**When to enable:**
- Technical or specialized content
- Content with background noise
- Professional documentation
- Content for publication

<Warning>
AI Review adds 10-20% more processing time but significantly improves quality. It preserves timestamps and never invents content.
</Warning>
...
For professional or important transcriptions, AI Review significantly improves:
- Accuracy of technical terms
- Readability and formatting
- Removal of speech disfluencies
...
3. **Enable AI Review for important content** - Professional and published content benefits significantly
4. **Use speaker diarization for conversations** - Makes multi-person transcripts much easier to follow
5. **Review critical transcripts** - Always review transcriptions for business-critical or legal use
