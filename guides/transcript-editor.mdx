...
Check if segment length matches your use case (subtitles need shorter, documents need longer). Use [**Resegment**](#resegment) to adjust timing before editing.
</Step>
...
<Note>
Need different segment timing? Use [**Resegment**](#resegment) to adjust timing with preset styles or custom rules.
</Note>
...
Change the timestamp intervals for each segment of your transcription. This tool restructures how your transcript is divided without changing the actual text.

**What it does:**
- Adjusts segment length and boundaries
- Re-divides transcript into different time intervals
- Optimizes segment breaks for readability or subtitle timing
- Maintains all text and speaker labels

**Resegmentation options:**
- **Preset Styles** - Subtitle, Sentence, or Paragraph formats
- **Use Case Presets** - Optimized for Podcast, Interview, or Meeting
- **Custom Control** - Define your own rules with word counts and time constraints

**Best for:** Converting between formats (meeting notes to subtitles), fixing timing issues, or optimizing readability

<Note>
See the [Resegment section](#resegment) below for detailed instructions on how to resegment your transcript.
</Note>
...
<Warning>
Resegmenting will override your current segment structure. If you've made segment-specific edits, consider doing this before edits.

</Warning>

**When to resegment:**

- **Before editing** - Segments break mid-sentence, are too short/long, or have poor readability
- **Converting formats** - Meeting notes to subtitles, subtitles to documents, or content to social media clips
- **Fixing timing issues** - Mid-word breaks, inconsistent lengths, or unnatural pauses

**How to resegment:**

<Steps>
<Step title="Open Agent Edit">
Click the **star icon** at the top right to open Agent Edit, then select **Resegment** under Transform
</Step>

<Step title="Configure Resegmentation Rules">
Click the **configure icon** to set your resegmentation rules. You can select a preset style or use case, or determine your own by applying word and time limits
</Step>

<Step title="Generate Preview">
Review the preview of your new segment structure
</Step>

<Step title="Apply Changes">
Confirm and apply the changes to your transcript
</Step>
</Steps>
...
| Style | Best For |
|-------|----------|
| **Subtitle** | Video subtitles, social media clips, accessibility captions |
| **Sentence** | Balanced readability, general-purpose transcripts |
| **Paragraph** | Long-form documents, blog posts, meeting notes |
...
|----------|---------------|
| **Podcast** | Natural speech patterns, storytelling flow |
| **Interview** | Q&A format, speaker turn-taking |
| **Meeting** | Discussion flow, multiple speakers |
...
- **Min/Max Words** - Control segment length by word count
- **Min/Max Duration** - Control segment timing in seconds
- **Combine both** - Set word and time constraints together for precise control
...
- **Check segmentation first** - [Resegment](#resegment) before editing if breaks are awkward or don't match your use case
...
Use [**Resegment**](#resegment) to adjust your segment timing:
...
1. [Resegment](#resegment) your transcript using the **Subtitle** preset style
